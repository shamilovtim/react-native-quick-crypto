// A JS implementation of Nodes's string_decoder
// https://github.com/nodejs/string_decoder/blob/main/lib/string_decoder.js
// Replaced the original buffer require (safe-buffer) for react-native-buffer
'use strict';

import { Buffer } from '@craftzdog/react-native-buffer';

var isEncoding = function (encoding: string) {
  encoding = '' + encoding;
...
export class StringDecoder {
  private lastNeed: number | undefined;
  private lastTotal: number | undefined;
  private lastChar: Buffer | undefined;
...
function utf8CheckByte(byte: any) {
...
// loop.
function utf8CheckExtraBytes(self: any, buf: Buffer, p: any): string | void {
  if ((buf[0] & 0xc0) !== 0x80) {
    self.lastNeed = 0;
    return '\ufffd';
  }
